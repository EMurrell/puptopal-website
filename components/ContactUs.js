          ...
          <div className="relative w-11/12 p-20 mx-auto bg-white sm:px-16">
            <div className="flex items-center pb-8">
              <div className="flex flex-col md:flex-row">
                <FadeIn>
                  <h1 className="mb-4 text-2xl font-extrabold text-green-600 font-display lg:text-4xl md:text-center md:text-3xl">
                    Get In Touch
                  </h1>
                </FadeIn>
                ...
                <div className="py-4 lg:pl-32 xl:pl-44 md:pl-6 sm:pl-6 ">
                  <FadeIn>
                    ...
                    <button className="px-6 py-2 mt-4 text-white transition duration-100 ease-in-out transform bg-green-600 shadow-lg rounded-3xl hover:bg-green-500 hover:scale-105">
