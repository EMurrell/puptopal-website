...
export default function ContactUs() {
  return (
    <div id="contact">
      <div className="container pt-16 mx-auto font-semibold text-gray-800 font-body"></div>
          ...
          <div className="relative w-11/12 p-20 mx-auto bg-white sm:px-16">
            <div className="flex items-center pb-8">
              <div className="flex flex-col md:flex-row">
                <FadeIn>
                  <h1 className="mb-4 text-2xl font-extrabold text-green-500 font-display lg:text-4xl md:text-center md:text-3xl">
                    Get In Touch
                  </h1>
                </FadeIn>
